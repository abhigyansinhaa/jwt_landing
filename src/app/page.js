      ...
      <div>
        ...
        <span className="hero0 z-20 relative text-9xl font-black text-white">
          ...
          <span className="hero1 z-20 relative text-5xl font-extrabold text-white">
            ...
            <a href="#link">
            <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-lg font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-red-200 via-red-300 to-yellow-200 dark:text-white focus:ring-4 z-20 hero2">
